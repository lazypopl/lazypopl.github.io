...
To illustrate the basic usage, here is a very simple first example, that doesn't use laziness. More advanced examples are in the menu above and further examples in the [Github repository](https://github.com/lazypopl/lazypopl.github.io/tree/main/lazyppl).
